    ...
    try{
        ...
        if(existedAppointments.length >= 3 && req.user.role !== 'admin'){
            return res.status(400).json({
                success: false,
                message: `The user with the id of ${req.user.id} has already made 3 appointments!`
            });
        }
        ...
        console.log(err.stack);
        return res.status(500).json({success: false, message: 'Cannot create Appoinment'});
    }
};
...
exports.updateAppointment = async(req, res, next) => {
    try{
        ...
        console.log(err.stack);
        return res.status(500).json({success: false, message: 'Cannot update Appoinment'});
    }
};
...
exports.deleteAppointment = async(req, res, next) => {
    try{
        ...
        console.log(err.stack);
        return res.status(500).json({success: false, message: 'Cannot delete Appoinment'});
    }
};